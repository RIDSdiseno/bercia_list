...
export async function createListItem(fields) {
    ...
    try {
        ...
        return await graphPost(`/sites/${cfg.siteId}/lists/${cfg.listId}/items`, { fields: safeFields });
    }
    catch (e) {
...
export async function createBerciaSolicitudItem(input) {
    const fields = {
